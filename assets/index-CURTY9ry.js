(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const o of n.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function a(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(s){if(s.ep)return;s.ep=!0;const n=a(s);fetch(s.href,n)}})();const Nt="daily-report-v2",J=[{id:"mentally",label:"Mentally"},{id:"psychology",label:"Psychology"},{id:"physically",label:"Physically"},{id:"spiritually",label:"Spiritually"},{id:"socially",label:"Socially"}],Yt=J.map(t=>t.id),Ht=[{id:"h1",name:"Wake up early",points:10,icon:"sunrise",category:"physically",pin:{mode:"forever"}},{id:"h2",name:"Drink water",points:5,icon:"drop",category:"physically",pin:{mode:"forever"}},{id:"h3",name:"Exercise",points:15,icon:"bolt",category:"physically",pin:{mode:"forever"}},{id:"h4",name:"Read 20 minutes",points:10,icon:"book",category:"mentally",pin:{mode:"forever"}},{id:"h5",name:"No junk food",points:10,icon:"leaf",category:"physically",pin:{mode:"forever"}}],Ct={lockTime:"21:00",autoLock:!0,showConscious:!0,habitSort:"default",taskSort:"default"},Q=[{id:"iron",label:"Iron",medal:"🥉",rank:1},{id:"bronze",label:"Bronze",medal:"🥉",rank:2},{id:"silver",label:"Silver",medal:"🥈",rank:3},{id:"gold",label:"Gold",medal:"🥇",rank:4}],Et=[{id:"habit-streak",label:"Habit streak"},{id:"task-streak",label:"Pinned task streak"},{id:"perfect-days",label:"Perfect days (100%)"}];function vt(t){var e;return((e=Q.find(a=>a.id===t))==null?void 0:e.rank)||0}function ct(t){var e;return((e=Q.find(a=>a.id===t))==null?void 0:e.medal)||"🏅"}function Lt(t){var e;return((e=Q.find(a=>a.id===t))==null?void 0:e.label)||t||"Badge"}function N(t){const e=Array.isArray(t)?t:String(t||"").split(","),a=[];return e.forEach(i=>{const s=String(i||"").trim().slice(0,20);s&&!a.some(n=>n.toLowerCase()===s.toLowerCase())&&a.push(s),a.length>=10}),a.slice(0,10)}function ot(t,e){const a=[...t];return e==="points"?a.sort((i,s)=>(Number(s.points)||0)-(Number(i.points)||0)):e==="category"?a.sort((i,s)=>Y(P(i.category)).localeCompare(Y(P(s.category)))):e==="tags"&&a.sort((i,s)=>(i.tags&&i.tags[0]||"~~~").localeCompare(s.tags&&s.tags[0]||"~~~")),a}const Rt=[{value:1,label:"Mon"},{value:2,label:"Tue"},{value:3,label:"Wed"},{value:4,label:"Thu"},{value:5,label:"Fri"},{value:6,label:"Sat"},{value:0,label:"Sun"}];function F(t=new Date){const e=t.getFullYear(),a=String(t.getMonth()+1).padStart(2,"0"),i=String(t.getDate()).padStart(2,"0");return`${e}-${a}-${i}`}function ft(){return{habits:{},habitRatings:{},habitMissed:{},habitForwarded:{},tasks:[],note:"",locked:!1,lockOverride:null,submittedAt:null,lockedHabits:null}}function P(t){return Yt.includes(t)?t:"mentally"}function Y(t){var e;return((e=J.find(a=>a.id===t))==null?void 0:e.label)||"Mentally"}function kt(t){const e=Math.max(0,Math.min(5,Number(t.rating)||0)),a=s=>/^\d{4}-\d{2}-\d{2}$/.test(String(s||""))?String(s):"",i=s=>Array.isArray(s)?s.filter(n=>/^\d{4}-\d{2}-\d{2}$/.test(String(n))).map(String).slice(0,50):[];return{...t,description:t.description||"",category:P(t.category),tags:N(t.tags),rating:e,done:!!t.done,missed:!!t.missed,forwardedFrom:a(t.forwardedFrom),forwardedHabitId:String(t.forwardedHabitId||""),forwardedTo:i(t.forwardedTo)}}function L(t){const e=Number(t);return!Number.isFinite(e)||e<0?0:Math.min(100,Math.round(e))}function I(t){if(!t||!t.mode)return null;const e=(s,n,o)=>Array.isArray(s)?s.map(Number).filter(r=>Number.isFinite(r)&&r>=n&&r<=o):[],a=s=>Array.isArray(s)?s.filter(n=>/^\d{4}-\d{2}-\d{2}$/.test(String(n))).map(String).slice(0,365):[],i=s=>Array.isArray(s)?s.filter(n=>/^\d{2}-\d{2}$/.test(String(n))).map(String).slice(0,366):[];return{mode:["forever","until","weekly","monthly","yearly","custom"].includes(t.mode)?t.mode:"forever",until:t.until||"",weekdays:e(t.weekdays,0,6),monthDays:e(t.monthDays,1,31),yearDays:i(t.yearDays),customDates:a(t.customDates),exceptDates:a(t.exceptDates||t.exceptions)}}function Jt(t,e){const a=`${t} ${e}`.toLowerCase();return a.includes("read")||a.includes("study")||a.includes("learn")?"mentally":a.includes("meditat")||a.includes("pray")||a.includes("journal")?"spiritually":a.includes("mood")||a.includes("calm")||a.includes("therapy")?"psychology":a.includes("friend")||a.includes("family")||a.includes("social")||a.includes("call")||a.includes("visit")?"socially":"physically"}function lt(t){const e=Et.some(a=>a.id===t.kind)?t.kind:"habit-streak";return{id:String(t.id||`g${Date.now()}`),title:String(t.title||"").trim().slice(0,60)||"My goal",kind:e,targetId:String(t.targetId||""),targetDays:Math.max(1,Math.min(365,Number(t.targetDays)||7)),tier:Q.some(a=>a.id===t.tier)?t.tier:"bronze",rewardTitle:String(t.rewardTitle||"").trim().slice(0,60)||"Reward",createdAt:t.createdAt||new Date().toISOString()}}function Ft(t){const e=(Array.isArray(t.habits)&&t.habits.length?t.habits:Ht).map(i=>({...i,description:String(i.description||"").slice(0,240),category:P(i.category||Jt(i.id,i.name)),consciousPoints:L(i.consciousPoints),tags:N(i.tags),pin:I(i.pin)})),a={};return Object.entries(t.days||{}).forEach(([i,s])=>{a[i]={...ft(),habits:s.habits||{},habitRatings:s.habitRatings||{},habitMissed:s.habitMissed||{},habitForwarded:s.habitForwarded&&typeof s.habitForwarded=="object"?s.habitForwarded:{},tasks:Array.isArray(s.tasks)?s.tasks.map(kt):[],note:s.note||"",locked:!!s.locked,lockOverride:s.lockOverride||(s.locked?"locked":null),submittedAt:s.submittedAt||null,lockedHabits:Array.isArray(s.lockedHabits)?s.lockedHabits:null}}),{habits:e,pinnedTasks:Array.isArray(t.pinnedTasks)?t.pinnedTasks.map(i=>({...kt(i),pin:I(i.pin)})):[],days:a,goals:Array.isArray(t.goals)?t.goals.map(lt):[],badges:Array.isArray(t.badges)?t.badges.filter(i=>i&&i.id&&i.goalId).map(i=>({id:String(i.id),goalId:String(i.goalId),title:String(i.title||""),tier:i.tier||"bronze",rewardTitle:String(i.rewardTitle||""),earnedAt:i.earnedAt||new Date().toISOString()})):[],settings:{lockTime:t.settings&&t.settings.lockTime||Ct.lockTime,autoLock:!t.settings||t.settings.autoLock!==!1,showConscious:!t.settings||t.settings.showConscious!==!1,habitSort:["default","points","category","tags"].includes(t.settings&&t.settings.habitSort)?t.settings.habitSort:"default",taskSort:["default","points","category","tags"].includes(t.settings&&t.settings.taskSort)?t.settings.taskSort:"default"}}}function $t(){return{habits:Ht.map(t=>({...t,description:"",tags:[]})),pinnedTasks:[],days:{},goals:[],badges:[],settings:{...Ct}}}function Qt(){try{const t=localStorage.getItem(Nt)||localStorage.getItem("daily-report-v1");return t?Ft(JSON.parse(t)):$t()}catch{return $t()}}let p=Qt();function $(){try{localStorage.setItem(Nt,JSON.stringify(p))}catch{}}function Xt(t){return new Date(`${t}T00:00:00`).getDay()}function U(t){const e=new Date(`${t}T00:00:00`);return e.setDate(e.getDate()-1),F(e)}function X(t,e){if(!t)return!0;if(Array.isArray(t.exceptDates)&&t.exceptDates.includes(e)||Array.isArray(t.exceptions)&&t.exceptions.includes(e))return!1;if((Array.isArray(t.customDates)?t.customDates:[]).includes(e)||t.mode==="forever")return!0;if(t.mode==="until")return!!t.until&&e<=t.until;if(t.mode==="weekly")return Array.isArray(t.weekdays)&&t.weekdays.includes(Xt(e));if(t.mode==="monthly"){const i=Array.isArray(t.monthDays)?t.monthDays.map(Number):[];return i.length?i.includes(Number(String(e).slice(8,10))):!0}if(t.mode==="yearly"){const i=Array.isArray(t.yearDays)?t.yearDays:[];return i.length?i.includes(String(e).slice(5,10)):!0}return t.mode!=="custom"}function Z(t){if(!t)return"Not pinned";const e=(t.exceptDates||t.exceptions||[]).length,a=e?` · ⛔ ${e} exception${e>1?"s":""}`:"",i=t.mode==="custom"?0:Array.isArray(t.customDates)?t.customDates.length:0,s=i?` +${i} custom`:"";if(t.mode==="forever")return`Pinned forever${s}${a}`;if(t.mode==="until")return`${t.until?`Pinned until ${t.until}`:"Pinned until a date"}${s}${a}`;if(t.mode==="weekly"){const n=Array.isArray(t.weekdays)?t.weekdays:[],o=Rt.filter(r=>n.includes(r.value)).map(r=>r.label);return`${o.length?`Weekly: ${o.join(", ")}`:"Weekly (no days)"}${s}${a}`}if(t.mode==="monthly"){const n=Array.isArray(t.monthDays)?t.monthDays:[];return`${n.length?`Monthly: day${n.length>1?"s":""} ${[...n].sort((o,r)=>o-r).join(", ")}`:"Monthly"}${s}${a}`}if(t.mode==="yearly"){const n=Array.isArray(t.yearDays)?t.yearDays:[];return`${n.length?`Yearly: ${[...n].sort().join(", ")}`:"Yearly"}${s}${a}`}if(t.mode==="custom"){const n=Array.isArray(t.customDates)?t.customDates:[];return`${n.length?`Custom: ${n.length} date${n.length>1?"s":""}`:"Custom dates"}${a}`}return"Pinned"}function wt(t){const[e,a]=(p.settings.lockTime||"21:00").split(":").map(Number),i=new Date(`${t}T00:00:00`);return i.setHours(e||0,a||0,0,0),i}function jt(t){const e=p.days[t];return e?e.lockOverride==="locked"||e.locked===!0:!1}function ut(t,e){const a=p.days[t];return a?a.habitRatings&&a.habitRatings[e]!=null?Number(a.habitRatings[e])||0:a.habits&&a.habits[e]?5:0:0}function pt(t){const e=T(t),a=p.habits.filter(i=>X(i.pin,t));e.lockedHabits=a.map(i=>({id:i.id,name:i.name,description:String(i.description||"").slice(0,240),points:Number(i.points)||0,icon:i.icon||"star",category:P(i.category),consciousPoints:L(i.consciousPoints),tags:N(i.tags),pin:I(i.pin)})),e.habitMissed={},a.forEach(i=>{ut(t,i.id)<=0?(e.habitMissed[i.id]=!0,e.habitRatings[i.id]=0,e.habits[i.id]=!1):e.habitMissed&&delete e.habitMissed[i.id]}),e.tasks.forEach(i=>{i.missed=!i.done})}function St(t){const e=T(t);return e.lockOverride==="unlocked"?!1:e.lockOverride==="locked"||e.locked?((!e.lockedHabits||e.habitMissed==null)&&pt(t),!0):p.settings.autoLock&&Date.now()>=wt(t).getTime()?(e.locked=!0,e.lockOverride="locked",e.submittedAt=e.submittedAt||wt(t).toISOString(),pt(t),$(),!0):!1}function T(t){return p.days[t]||(p.days[t]=ft()),p.days[t]}function Zt(t){const e=T(t);if(jt(t))return e;let a=!1;return p.pinnedTasks.forEach(i=>{X(i.pin,t)&&(e.tasks.some(s=>s.sourcePinId===i.id)||(e.tasks.push({id:`ptask-${i.id}-${t}`,title:i.title,points:i.points,description:i.description||"",category:P(i.category),tags:N(i.tags),rating:0,done:!1,missed:!1,sourcePinId:i.id}),a=!0))}),a&&$(),e}function R(t){return!c.isLocked(t)}function xt(t){const e=J.find(a=>a.label.toLowerCase()===String(t||"").trim().toLowerCase());return e?e.id:"mentally"}function Dt(t){return!t||typeof t!="object"||Array.isArray(t)?[]:Array.isArray(t.days)?t.days.filter(e=>e&&/^\d{4}-\d{2}-\d{2}$/.test(String(e.date||""))):[]}const c={todayKey:F,exportBackup(){return JSON.stringify({app:"Daily Report",kind:"full-backup",version:1,exportedAt:new Date().toISOString(),data:p},null,2)},backupKind(t){if(!t||typeof t!="object"||Array.isArray(t))return"invalid";const e=t.data&&typeof t.data=="object"&&!Array.isArray(t.data)?t.data:t;return Array.isArray(e.days)?"report-export":Array.isArray(e.categories)||Array.isArray(e.plans)||Array.isArray(e.schedule)?"wrong-app":typeof e!="object"||e===null||e.habits!==void 0&&!Array.isArray(e.habits)||e.days!==void 0&&(typeof e.days!="object"||e.days===null||Array.isArray(e.days))||e.settings!==void 0&&(typeof e.settings!="object"||e.settings===null||Array.isArray(e.settings))||!["habits","pinnedTasks","days","goals","badges","settings"].some(i=>e[i]!==void 0)?"invalid":"ok"},importBackup(t){if(this.backupKind(t)!=="ok")return!1;const e=t.data&&typeof t.data=="object"&&!Array.isArray(t.data)?t.data:t;return p=Ft(e),$(),!0},previewReport(t){const e=Dt(t);if(!e.length)return{days:0,start:"",end:"",newHabits:0};const a=new Set(p.habits.map(n=>String(n.name||"").trim().toLowerCase())),i=new Set;e.forEach(n=>{(Array.isArray(n.habits)?n.habits:[]).forEach(o=>{const r=String(o&&o.name||"").trim().toLowerCase();r&&!a.has(r)&&i.add(r)})});const s=e.map(n=>String(n.date)).sort();return{days:e.length,start:s[0],end:s[s.length-1],newHabits:i.size}},importReport(t){const e=Dt(t);if(!e.length)return!1;const a=e.map(r=>String(r.date)).sort(),i=a[a.length-1],s={};p.habits.forEach(r=>{s[String(r.name||"").trim().toLowerCase()]=r});let n=0;const o=Date.now();return e.forEach((r,u)=>{const d=String(r.date);(Array.isArray(r.habits)?r.habits:[]).forEach(l=>{const k=String(l&&l.name||"").trim().slice(0,80);if(!k)return;const A=k.toLowerCase();if(!s[A]){const h={id:`h${o}_${n}`,name:k,description:String(l&&l.description||"").slice(0,240),points:Number(l&&l.points||10)||10,icon:"star",category:xt(l&&l.category),consciousPoints:L(l&&l.consciousPoints),tags:N(l&&l.tags),pin:{mode:"until",until:i,weekdays:[],monthDays:[],yearDays:[],customDates:[],exceptDates:[]}};p.habits.push(h),s[A]=h,n+=1}});const y=ft();y.note=String(r.note||""),y.locked=!0,y.lockOverride="locked",y.submittedAt=null;const x=[];(Array.isArray(r.habits)?r.habits:[]).forEach(l=>{const k=s[String(l&&l.name||"").trim().toLowerCase()];if(!k)return;const A=Math.max(0,Math.min(5,Number(l&&l.rating||0)));y.habitRatings[k.id]=A,y.habits[k.id]=A>0,A<=0&&(y.habitMissed[k.id]=!0),x.push({id:k.id,name:k.name,description:k.description,points:k.points,icon:k.icon||"star",category:P(k.category),consciousPoints:L(k.consciousPoints),tags:N(k.tags),pin:I(k.pin)})}),y.lockedHabits=x,y.tasks=(Array.isArray(r.tasks)?r.tasks:[]).map((l,k)=>({id:`t${o}_${u}_${k}`,title:String(l&&l.title||"Task").slice(0,120),points:Number(l&&l.points||5)||5,description:String(l&&l.description||""),category:xt(l&&l.category),tags:N(l&&l.tags),rating:Math.max(0,Math.min(5,Number(l&&l.rating||0))),done:!!(l&&l.done),missed:!(l&&l.done),forwardedFrom:/^\d{4}-\d{2}-\d{2}$/.test(String(l&&l.forwardedFrom||""))?String(l.forwardedFrom):"",forwardedHabitId:"",forwardedTo:Array.isArray(l&&l.forwardedTo)?l.forwardedTo.filter(A=>/^\d{4}-\d{2}-\d{2}$/.test(String(A))).map(String).slice(0,50):[]})),p.days[d]=y}),$(),{days:e.length,habits:n}},getSettings(){return p.settings},setLockTime(t){p.settings.lockTime=t||"21:00",$()},setAutoLock(t){p.settings.autoLock=!!t,$()},setShowConscious(t){p.settings.showConscious=!!t,$()},consciousEnabled(){return p.settings.showConscious!==!1},setHabitSort(t){p.settings.habitSort=["default","points","category","tags"].includes(t)?t:"default",$()},setTaskSort(t){p.settings.taskSort=["default","points","category","tags"].includes(t)?t:"default",$()},getHabits(t,e){if(t&&jt(t)){const n=p.days[t];if(n&&Array.isArray(n.lockedHabits)){const o=e||p.settings.habitSort||"default",r=[...n.lockedHabits];return o==="default"?r:ot(r,o)}}const i=p.habits.filter(n=>t?X(n.pin,t):!0).sort((n,o)=>+!!o.pin-+!!n.pin),s=e||p.settings.habitSort||"default";return s==="default"?i:ot(i,s)},getTasks(t,e){const a=this.getDay(t),i=e||p.settings.taskSort||"default";return i==="default"?a.tasks:ot(a.tasks,i)},getAllHabits(){return p.habits},getPinnedTasks(){return p.pinnedTasks},getDay(t){return St(t),Zt(t)},isLocked(t){return St(t)},submitDay(t){const e=T(t);e.locked=!0,e.lockOverride="locked",e.submittedAt=new Date().toISOString(),pt(t),$(),this.checkGoals(t)},unlockDay(t){const e=T(t);e.locked=!1,e.lockOverride="unlocked",e.habitMissed={},e.lockedHabits=null,e.tasks.forEach(a=>{a.missed=!1}),$()},isHabitMissed(t,e){const a=p.days[t];return!a||!(a.locked||a.lockOverride==="locked")?!1:a.habitMissed&&a.habitMissed[e]?!0:ut(t,e)<=0},isTaskMissed(t,e){const a=p.days[t];if(!a)return!1;const i=(a.tasks||[]).find(s=>s.id===e);return i?i.missed===!0?!0:i.missed===!1?!1:!!(a.locked||a.lockOverride==="locked")&&!i.done:!1},missedCounts(t){const e=this.getDay(t),a=this.getHabits(t),i=!!(e.locked||e.lockOverride==="locked");return{habits:a.filter(s=>e.habitMissed&&e.habitMissed[s.id]?!0:i&&ut(t,s.id)<=0).length,tasks:e.tasks.filter(s=>s.done?!1:s.missed===!0?!0:s.missed===!1?!1:i).length}},lockDay(t){this.submitDay(t)},lockedReports(){return Object.keys(p.days).sort().reverse().filter(t=>this.isLocked(t)).map(t=>({date:t,submittedAt:p.days[t].submittedAt,...this.scoreFor(t)}))},habitRating(t,e){const a=p.days[t];return a?a.habitRatings&&a.habitRatings[e]!=null?Number(a.habitRatings[e])||0:a.habits&&a.habits[e]?5:0:0},setHabitRating(t,e,a){if(!R(t))return;const i=T(t),s=Math.max(0,Math.min(5,Number(a)||0));i.habitRatings[e]=s,i.habits[e]=s>0,$(),this.checkGoals(t)},toggleHabit(t,e){if(!R(t))return;const a=this.habitRating(t,e)>0?0:5;this.setHabitRating(t,e,a)},addTask(t,e,a,i={}){if(!R(t))return;T(t).tasks.push({id:`t${Date.now()}`,title:e.trim(),points:Number(a)||5,description:String(i.description||"").trim(),category:P(i.category),tags:N(i.tags),rating:Math.max(0,Math.min(5,Number(i.rating)||0)),done:!1,missed:!1,forwardedFrom:/^\d{4}-\d{2}-\d{2}$/.test(String(i.forwardedFrom||""))?String(i.forwardedFrom):"",forwardedHabitId:String(i.forwardedHabitId||""),forwardedTo:[]}),$(),this.checkGoals(t)},setTaskRating(t,e,a){if(!R(t))return;const s=T(t).tasks.find(o=>o.id===e);if(!s)return;const n=Math.max(0,Math.min(5,Number(a)||0));s.rating=n,$()},toggleTask(t,e){if(!R(t))return;const i=T(t).tasks.find(s=>s.id===e);i&&(i.done=!i.done,$(),this.checkGoals(t))},removeTask(t,e){if(!R(t))return;const a=T(t);a.tasks=a.tasks.filter(i=>i.id!==e),$()},forwardTask(t,e,a){if(!/^\d{4}-\d{2}-\d{2}$/.test(String(a||"")))return{ok:!1,reason:"Pick a valid date"};if(t===a)return{ok:!1,reason:"Already on that day"};if(!R(t))return{ok:!1,reason:"Source day is locked"};if(this.isLocked(a))return{ok:!1,reason:"Target day is locked"};const s=T(t).tasks.find(r=>r.id===e);if(!s)return{ok:!1,reason:"Task not found"};T(a).tasks.push({id:`t${Date.now()}`,title:s.title,points:Number(s.points)||5,description:String(s.description||""),category:P(s.category),tags:N(s.tags),rating:0,done:!1,missed:!1,forwardedFrom:t,forwardedHabitId:String(s.forwardedHabitId||""),forwardedTo:[]});const o=Array.isArray(s.forwardedTo)?s.forwardedTo:[];return o.includes(a)||o.push(a),s.forwardedTo=o.slice(0,50),$(),this.checkGoals(a),{ok:!0}},forwardHabit(t,e,a){if(!/^\d{4}-\d{2}-\d{2}$/.test(String(a||"")))return{ok:!1,reason:"Pick a valid date"};if(t===a)return{ok:!1,reason:"Already on that day"};if(!R(t))return{ok:!1,reason:"Source day is locked"};if(this.isLocked(a))return{ok:!1,reason:"Target day is locked"};const i=p.habits.find(r=>r.id===e);if(!i)return{ok:!1,reason:"Habit not found"};T(a).tasks.push({id:`t${Date.now()}`,title:i.name,points:Number(i.points)||10,description:String(i.description||""),category:P(i.category),tags:N(i.tags),rating:0,done:!1,missed:!1,forwardedFrom:t,forwardedHabitId:e,forwardedTo:[]});const n=T(t);(!n.habitForwarded||typeof n.habitForwarded!="object")&&(n.habitForwarded={});const o=Array.isArray(n.habitForwarded[e])?n.habitForwarded[e]:[];return o.includes(a)||o.push(a),n.habitForwarded[e]=o.slice(0,50),$(),this.checkGoals(a),{ok:!0}},habitForwardedTo(t,e){const a=p.days[t];if(!a||!a.habitForwarded)return[];const i=a.habitForwarded[e];return Array.isArray(i)?i:[]},setNote(t,e){R(t)&&(T(t).note=e,$())},addHabit(t,e,a={}){p.habits.push({id:`h${Date.now()}`,name:t.trim(),description:String(a.description||"").trim().slice(0,240),points:Number(e)||10,icon:"star",category:P(a.category||"physically"),consciousPoints:L(a.consciousPoints),tags:N(a.tags),pin:{mode:"forever",until:"",weekdays:[]}}),$()},updateHabit(t,e){const a=p.habits.find(i=>i.id===t);a&&(e.name!=null&&(a.name=String(e.name).trim()||a.name),e.description!=null&&(a.description=String(e.description).trim().slice(0,240)),e.points!=null&&(a.points=Number(e.points)||a.points),e.category!=null&&(a.category=P(e.category)),e.consciousPoints!=null&&(a.consciousPoints=L(e.consciousPoints)),e.tags!=null&&(a.tags=N(e.tags)),$())},updateTask(t,e,a){if(!R(t))return;const s=T(t).tasks.find(n=>n.id===e);if(s){if(a.title!=null&&(s.title=String(a.title).trim()||s.title),a.points!=null&&(s.points=Number(a.points)||s.points),a.description!=null&&(s.description=String(a.description).trim()),a.category!=null&&(s.category=P(a.category)),a.tags!=null&&(s.tags=N(a.tags)),a.rating!=null&&(s.rating=Math.max(0,Math.min(5,Number(a.rating)||0))),s.sourcePinId){const n=p.pinnedTasks.find(o=>o.id===s.sourcePinId);n&&(n.title=s.title,n.points=s.points,n.description=s.description,n.category=s.category,a.tags!=null&&(n.tags=N(a.tags)))}$()}},habitStreak(t,e){const a=p.habits.find(o=>o.id===t);if(!a)return 0;let i=e,s=0;this.habitRating(i,t)===0&&(i=U(i));let n=0;for(;s<400;){if(s+=1,!X(a.pin,i)){i=U(i);continue}if(this.habitRating(i,t)>0){n+=1,i=U(i);continue}break}return n},categoryBreakdown(t){const e=this.getDay(t),a=this.getHabits(t);return J.map(i=>{const s=a.filter(h=>P(h.category)===i.id),n=e.tasks.filter(h=>P(h.category)===i.id),o=s.reduce((h,w)=>{const nt=this.habitRating(t,w.id);return h+Math.round(w.points*nt/5)},0),r=p.settings.showConscious!==!1,u=r?s.reduce((h,w)=>h+(this.habitRating(t,w.id)>0?L(w.consciousPoints):0),0):0,d=s.reduce((h,w)=>h+w.points,0),y=r?s.reduce((h,w)=>h+L(w.consciousPoints),0):0,x=n.reduce((h,w)=>h+(w.done?w.points:0),0),l=n.reduce((h,w)=>h+w.points,0),k=s.map(h=>this.habitRating(t,h.id)),A=k.length?Math.round(k.reduce((h,w)=>h+w,0)/k.length*10)/10:0;return{...i,habits:s,tasks:n,earned:o+u+x,max:d+y+l,habitAvg:A,consciousEarned:u,consciousMax:y,completed:s.filter(h=>this.habitRating(t,h.id)>0).length+n.filter(h=>h.done).length,total:s.length+n.length}})},removeHabit(t){p.habits=p.habits.filter(e=>e.id!==t),$()},pinHabit(t,e){const a=p.habits.find(i=>i.id===t);a&&(a.pin=I(e),$())},unpinHabit(t){const e=p.habits.find(a=>a.id===t);e&&(e.pin=null,$())},pinTask(t,e,a){const s=T(t).tasks.find(o=>o.id===e);if(!s)return;if(s.sourcePinId){const o=p.pinnedTasks.find(r=>r.id===s.sourcePinId);if(o){o.pin=I(a),$();return}}const n=`p${Date.now()}`;p.pinnedTasks.push({id:n,title:s.title,points:s.points,description:s.description||"",category:P(s.category),tags:N(s.tags),pin:I(a)}),s.sourcePinId=n,$()},unpinTaskTemplate(t){p.pinnedTasks=p.pinnedTasks.filter(e=>e.id!==t),$()},updatePinnedTask(t,e){const a=p.pinnedTasks.find(i=>i.id===t);a&&(a.pin=I(e),$())},findHabit(t){return p.habits.find(e=>e.id===t)||null},findTask(t,e){return T(t).tasks.find(a=>a.id===e)||null},findPinnedTask(t){return p.pinnedTasks.find(e=>e.id===t)||null},getGoals(){return p.goals},getBadges(){return[...p.badges].sort((t,e)=>{const a=vt(e.tier)-vt(t.tier);return a!==0?a:String(e.earnedAt).localeCompare(String(t.earnedAt))})},topBadges(t=3){return this.getBadges().slice(0,t)},addGoal(t={}){const e=lt({...t,id:`g${Date.now()}`});return p.goals.push(e),$(),this.checkGoals(F()),e},updateGoal(t,e={}){const a=p.goals.find(s=>s.id===t);if(!a)return;const i=lt({...a,...e,id:t});Object.assign(a,i),$(),this.checkGoals(F())},removeGoal(t){p.goals=p.goals.filter(e=>e.id!==t),$()},removeBadge(t){p.badges=p.badges.filter(e=>e.id!==t),$()},perfectDaysCount(){return Object.keys(p.days).filter(t=>{const e=this.scoreFor(t);return e.max>0&&e.percent===100}).length},taskStreak(t,e){let a=e,i=0;(o=>{const r=p.days[o];return!r||!Array.isArray(r.tasks)?!1:r.tasks.some(u=>u.sourcePinId===t&&u.done)})(a)||(a=U(a));let n=0;for(;i<400;){i+=1;const o=p.days[a];if(!o||!Array.isArray(o.tasks))break;if(o.tasks.some(r=>r.sourcePinId===t&&r.done)){n+=1,a=U(a);continue}break}return n},goalProgress(t,e){const a=e||F();if(t.kind==="habit-streak"){const s=this.habitStreak(t.targetId,a);return{current:s,target:t.targetDays,done:s>=t.targetDays}}if(t.kind==="task-streak"){const s=this.taskStreak(t.targetId,a);return{current:s,target:t.targetDays,done:s>=t.targetDays}}const i=this.perfectDaysCount();return{current:i,target:t.targetDays,done:i>=t.targetDays}},checkGoals(t){const e=t||F();let a=[];return p.goals.forEach(i=>{if(p.badges.some(n=>n.goalId===i.id))return;if(this.goalProgress(i,e).done){const n={id:`b${Date.now()}-${i.id}`,goalId:i.id,title:i.title,tier:i.tier,rewardTitle:i.rewardTitle,earnedAt:new Date().toISOString()};p.badges.push(n),a.push(n)}}),a.length&&$(),a},scoreFor(t){const e=this.getDay(t),a=this.getHabits(t),i=this.isLocked(t),s=p.settings.showConscious!==!1,n=a.reduce((h,w)=>{const nt=this.habitRating(t,w.id);return h+Math.round(w.points*nt/5)},0),o=s?a.reduce((h,w)=>h+(this.habitRating(t,w.id)>0?L(w.consciousPoints):0),0):0,r=e.tasks.reduce((h,w)=>h+(w.done?w.points:0),0),u=a.reduce((h,w)=>h+w.points,0),d=s?a.reduce((h,w)=>h+L(w.consciousPoints),0):0,y=e.tasks.reduce((h,w)=>h+w.points,0),x=n+o+r,l=u+d+y,k=a.filter(h=>e.habitMissed&&e.habitMissed[h.id]?!0:i&&this.habitRating(t,h.id)<=0).length,A=e.tasks.filter(h=>h.done?!1:h.missed===!0?!0:h.missed===!1?!1:i).length;return{earned:x,max:l,habitScore:n,consciousScore:o,maxConscious:d,taskScore:r,completedHabits:a.filter(h=>this.habitRating(t,h.id)>0).length,habitAvg:a.length?Math.round(a.reduce((h,w)=>h+this.habitRating(t,w.id),0)/a.length*10)/10:0,totalHabits:a.length,completedTasks:e.tasks.filter(h=>h.done).length,totalTasks:e.tasks.length,missedHabits:k,missedTasks:A,percent:l?Math.round(x/l*100):0,locked:i,submittedAt:e.submittedAt}},monthKeys(t){const e=String(t).slice(0,7);return Object.keys(p.days).filter(a=>a.startsWith(e)).sort()},rangeKeys(t,e){const a=[],i=new Date(`${t}T00:00:00`),s=new Date(`${e}T00:00:00`);let n=0;for(;i<=s&&n<732;)n+=1,a.push(F(i)),i.setDate(i.getDate()+1);return a},resolveRange(t,e){if(t==="day")return[e,e];if(t==="week"){const i=new Date(`${e}T00:00:00`),s=i.getDay(),n=s===0?-6:1-s,o=new Date(i);o.setDate(i.getDate()+n);const r=new Date(o);return r.setDate(o.getDate()+6),[F(o),F(r)]}if(t==="month"){const[i,s]=e.split("-").map(Number),n=`${i}-${String(s).padStart(2,"0")}-01`,o=new Date(i,s,0).getDate(),r=`${i}-${String(s).padStart(2,"0")}-${String(o).padStart(2,"0")}`;return[n,r]}if(t==="year"){const i=e.slice(0,4);return[`${i}-01-01`,`${i}-12-31`]}const a=Object.keys(p.days).sort();return a.length?[a[0],a[a.length-1]>e?a[a.length-1]:e]:[e,e]},exportRows(t,e){return this.rangeKeys(t,e).map(a=>{const i=this.getDay(a),s=this.getHabits(a),n=this.scoreFor(a),o=this.isLocked(a),r=(d,y)=>y>0?"done":o?"missed":"pending",u=d=>d.done?"done":o?"missed":"pending";return{date:a,earned:n.earned,max:n.max,percent:n.percent,habitScore:n.habitScore,consciousScore:n.consciousScore||0,taskScore:n.taskScore,locked:o,missedHabits:n.missedHabits||0,missedTasks:n.missedTasks||0,note:i.note||"",habits:s.map(d=>{const y=this.habitRating(a,d.id);return{name:d.name,description:String(d.description||""),category:Y(P(d.category)),tags:N(d.tags),points:d.points,consciousPoints:this.consciousEnabled()?L(d.consciousPoints):0,rating:y,earned:Math.round(d.points*y/5)+(y>0&&this.consciousEnabled()?L(d.consciousPoints):0),status:r(d.id,y)}}),tasks:i.tasks.map(d=>({title:d.title,category:Y(P(d.category)),tags:N(d.tags),points:d.points,rating:Math.max(0,Math.min(5,Number(d.rating)||0)),done:!!d.done,earned:d.done?d.points:0,status:d.forwardedFrom?`forwarded from ${d.forwardedFrom}`:u(d),forwardedFrom:d.forwardedFrom||"",forwardedTo:Array.isArray(d.forwardedTo)?d.forwardedTo:[],description:d.description||""}))}})},history(t=14){return Object.keys(p.days).sort().reverse().slice(0,t).map(a=>({date:a,...this.scoreFor(a),note:p.days[a].note,locked:this.isLocked(a),submittedAt:p.days[a].submittedAt}))},week(t){const e=new Date(t),a=e.getDay(),i=a===0?-6:1-a;return e.setDate(e.getDate()+i),e.setHours(0,0,0,0),Array.from({length:7},(s,n)=>{const o=new Date(e);o.setDate(e.getDate()+n);const r=F(o);return{date:r,label:o.toLocaleDateString(void 0,{weekday:"short"}),locked:this.isLocked(r),...this.scoreFor(r)}})}};function Bt(t){return t>=90?"Excellent":t>=75?"Great day":t>=50?"Keep going":t>0?"Started":"No score yet"}function O(t){return new Date(`${t}T00:00:00`).toLocaleDateString(void 0,{weekday:"long",month:"short",day:"numeric"})}function Ot(t){return t?new Date(t).toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit"}):""}function K(t){return t>=5?"Excellent":t>=4?"Great":t>=3?"Good":t>=2?"Fair":t>=1?"Low":"Not rated"}const rt=document.getElementById("app"),Kt="v1.0 — Install · Offline · Backup location · Import/Export",dt=1;let g=c.todayKey(),H="today",v=null,m=null,G=!1,tt=!1,_=null,q=!1,mt=!1,It=null,B="Idle.",M=null,D="boot";window.addEventListener("beforeinstallprompt",t=>{t.preventDefault(),_=t});window.addEventListener("appinstalled",()=>{_=null,f("Daily Report installed"),S()});const te=[["default","Default"],["points","Points"],["category","Category"],["tags","Tags"]];function At(t){const e=new Date(`${g}T00:00:00`);e.setDate(e.getDate()+t),g=c.todayKey(e)}function E(t){return{home:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 10.5 12 4l8 6.5V20a1 1 0 0 1-1 1h-5v-6H10v6H5a1 1 0 0 1-1-1z"/></svg>',week:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="5" width="18" height="16" rx="2"/><path d="M3 10h18M8 3v4M16 3v4"/></svg>',history:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 8v5l3 2"/><circle cx="12" cy="12" r="9"/></svg>',settings:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.7 1.7 0 0 0 .3 1.8l.1.1a2 2 0 1 1-2.8 2.8l-.1-.1a1.7 1.7 0 0 0-1.8-.3 1.7 1.7 0 0 0-1 1.5V21a2 2 0 0 1-4 0v-.1a1.7 1.7 0 0 0-1.1-1.5 1.7 1.7 0 0 0-1.8.3l-.1.1a2 2 0 1 1-2.8-2.8l.1-.1a1.7 1.7 0 0 0 .3-1.8 1.7 1.7 0 0 0-1.5-1H3a2 2 0 0 1 0-4h.1a1.7 1.7 0 0 0 1.5-1.1 1.7 1.7 0 0 0-.3-1.8l-.1-.1a2 2 0 1 1 2.8-2.8l.1.1a1.7 1.7 0 0 0 1.8.3H8a1.7 1.7 0 0 0 1-1.5V3a2 2 0 0 1 4 0v.1a1.7 1.7 0 0 0 1 1.5 1.7 1.7 0 0 0 1.8-.3l.1-.1a2 2 0 1 1 2.8 2.8l-.1.1a1.7 1.7 0 0 0-.3 1.8V8c.3.7.9 1.2 1.6 1.3H21a2 2 0 0 1 0 4h-.1a1.7 1.7 0 0 0-1.5 1.7z"/></svg>',pin:'<svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 4h6l-1 7 3 3v2H7v-2l3-3z" fill="currentColor" stroke="none"/><path d="M12 16v5"/></svg>',forward:'<svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M13 6l6 6-6 6"/></svg>',habit:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 7h16M4 12h10M4 17h13"/></svg>'}[t]}function Gt(t,e,a){return`
  ...
  `}function _t(t){const e=Number(t)||0;return e?`<span class="conscious-badge">🧠 +${e}</span>`:'<span class="item-meta">No conscious pts</span>'}function et(t){return`<span class="cat-badge cat-${t}">${Y(t)}</span>`}function W(t){const e=Array.isArray(t)?t.filter(Boolean):[];return e.length?`<div class="tag-row">${e.map(a=>`<span class="tag-chip">#${b(a)}</span>`).join("")}</div>`:""}function Tt(t,e){return`
    <select class="sort-select" data-sort-kind="${t}" aria-label="Sort ${t}">
      ${te.map(([a,i])=>`<option value="${a}" ${e===a?"selected":""}>${i}</option>`).join("")}
    </select>
  `}function ee(t){const e=c.getBadges(),a=c.topBadges(3),i=t.max>0&&t.percent===100,s=tt?e:a;return`
          ...
          ${s.map(n=>`
            <article class="reward-card tier-${n.tier}">
              ...
              <div>
                ...
                <div class="item-meta">${b(n.title)} · ${Lt(n.tier)} · ${O((n.earnedAt||"").slice(0,10))}</div>
              </div>
            </article>
          `).join("")}
        </div>
  ...
  `}function at(t){return`<span class="streak-badge">${t} day streak</span>`}function Wt(t){return t?`<span class="forward-badge from">↩ Forwarded from ${b(t)}</span>`:""}function st(t){const e=Array.isArray(t)?t.filter(Boolean):[];return e.length?`<span class="forward-badge to">↪ Forwarded to ${b(e[e.length-1])}</span>`:""}function ae(t){const e=new Date(`${t}T00:00:00`);return e.setDate(e.getDate()+1),c.todayKey(e)}function gt(){return`<button class="ghost-btn compact ${G?"on":""}" data-action="toggle-edit">${G?"Done":"Edit Mode"}</button>`}function se(t){return t?'<span class="lock-badge">Locked</span>':'<span class="open-badge">Open</span>'}function ie(){c.checkGoals(g);const t=c.getDay(g),e=c.getSettings(),a=e.showConscious!==!1,i=c.getHabits(g),s=c.getTasks(g),n=c.scoreFor(g),o=Bt(n.percent),r=g===c.todayKey(),u=c.isLocked(g);return`
    <div class="topbar">
      <div>
    ...
    <section class="section">
      <div class="section-head">
        ...
        <div class="head-actions">
          ${Tt("habit",e.habitSort||"default")}
          ${gt()}
          <span class="points">+${n.habitScore}${a&&n.consciousScore?` +${n.consciousScore}🧠`:""} pts</span>
        </div>
      </div>
      <div class="list">
        ${i.length?i.map(d=>{const y=c.habitRating(g,d.id),x=y>0,l=!x&&u,k=c.habitStreak(d.id,g),A=a&&Number(d.consciousPoints)||0;return`
                    <article class="item-card ${x?"done":""} ${l?"missed":""} ${u?"is-locked":""}">
                      ...
                      <div>
                        ...
                        ${a?`<div class="item-meta">${at(k)} ${_t(A)}</div>`:`<div class="item-meta">${at(k)}</div>`}
                        ${st(c.habitForwardedTo(g,d.id))}
                        ${W(d.tags)}
                        ${Gt(d.id,y,u)}
                      </div>
                      <div class="item-side">
                        <div class="points">+${d.points}${A?` +${A}🧠`:""}</div>
                        <div class="mini-actions">
                          ${G?`<button class="mini-btn on" data-action="open-edit-habit" data-id="${d.id}" ${u?"disabled":""}>Edit</button>`:""}
                          <button class="mini-btn" data-action="open-forward-habit" data-id="${d.id}" ${u?"disabled":""} title="Forward habit to another day">${E("forward")}</button>
                          <button class="mini-btn ${d.pin?"on":""}" data-action="open-pin-habit" data-id="${d.id}" ${u?"disabled":""} title="Pin habit">${E("pin")}</button>
                        </div>
                      </div>
                    </article>
    ...
    <section class="section">
      <div class="section-head">
        <h2>Tasks</h2>
        <div class="head-actions">
          ${Tt("task",e.taskSort||"default")}
          ${gt()}
          <span class="points">+${n.taskScore} pts</span>
        </div>
      </div>
      <div class="list">
        ${s.length?s.map(d=>{const y=!!d.sourcePinId,x=y?c.findPinnedTask(d.sourcePinId):null,l=Math.max(0,Math.min(5,Number(d.rating)||0)),k=!d.done&&u;return`
                    <article class="item-card ${d.done?"done":""} ${k?"missed":""} ${u?"is-locked":""}">
                      ...
                      <div>
                        ...
                        <div class="item-meta">${et(d.category)} ${x?Z(x.pin):"One-time task"} · ${d.done?"Done":u?"Missed":"Pending"} · ${l?`${l}/5 ${K(l)}`:"No rating"}</div>
                        ${d.description?`<p class="item-desc">${b(d.description)}</p>`:""}
                        ${Wt(d.forwardedFrom)}
                        ${st(d.forwardedTo)}
                        ${W(d.tags)}
                      ...
                      <div class="item-side">
                        ...
                        <div class="mini-actions">
                          ...
                          <button class="mini-btn" data-action="open-forward-task" data-id="${d.id}" ${u?"disabled":""} title="Forward task to another day">${E("forward")}</button>
                          <button class="mini-btn ${y?"on":""}" data-action="open-pin-task" data-id="${d.id}" ${u?"disabled":""} title="Pin task">${E("pin")}</button>
  ...
  `}function ne(){const t=c.week(new Date(`${g}T00:00:00`)),e=t.reduce((i,s)=>i+s.earned,0),a=Math.round(e/7);return`
    <div class="topbar">
      <div>
  ...
  `}function oe(){const t=c.history(21);return`
    <div class="topbar">
      <div>
  ...
  `}function re(){const t=c.isLocked(g),e=c.consciousEnabled(),a=c.categoryBreakdown(g),i=a.reduce((n,o)=>n+o.earned,0),s=a.reduce((n,o)=>n+o.max,0);return`
    <div class="topbar">
      <div>
    ...
    ${a.map(n=>{const o=n.max?Math.round(n.earned/n.max*100):0;return`
          <section class="section">
            ...
            <div class="list" style="margin-top:10px">
              ${n.habits.length||n.tasks.length?`
                    ${n.habits.map(r=>{const u=c.habitRating(g,r.id),d=!u&&t,y=c.habitStreak(r.id,g),x=e&&Number(r.consciousPoints)||0,l=u>0?x:0,k=Math.round(r.points*u/5)+l,A=r.points+x;return`
                          <article class="item-card ${u?"done":""} ${d?"missed":""} ${t?"is-locked":""}">
                            ...
                            <div>
                              ...
                              <div class="item-meta">Habit · ${u?`${u}/5 ${K(u)}`:t?"Missed":"Not rated"} · ${at(y)}${e?` ${_t(x)}`:""}</div>
        ...
        `}).join("")}
  `}function it(t){return`${t||"daily-report-backup"}-${c.todayKey()}.json`}function zt(){return typeof window.showDirectoryPicker=="function"}function ht(){return new Promise((t,e)=>{const a=indexedDB.open("daily-report-pwa",1);a.onupgradeneeded=()=>a.result.createObjectStore("kv"),a.onsuccess=()=>t(a.result),a.onerror=()=>e(a.error)})}function de(t){return ht().then(e=>new Promise((a,i)=>{const s=e.transaction("kv","readonly").objectStore("kv").get(t);s.onsuccess=()=>a(s.result),s.onerror=()=>i(s.error)}))}function ce(t,e){return ht().then(a=>new Promise((i,s)=>{const n=a.transaction("kv","readwrite");n.objectStore("kv").put(e,t),n.oncomplete=()=>i(),n.onerror=()=>s(n.error)}))}function le(t){return ht().then(e=>new Promise((a,i)=>{const s=e.transaction("kv","readwrite");s.objectStore("kv").delete(t),s.oncomplete=()=>a(),s.onerror=()=>i(s.error)}))}function ue(){return!zt()||typeof indexedDB>"u"?(D="unsupported",Promise.resolve()):de("backupDir").then(t=>{if(M=t||null,!M){D="unset";return}return M.queryPermission({mode:"readwrite"}).then(e=>{D=e==="granted"?"granted":"prompt"}).catch(()=>{D="prompt"})}).catch(()=>{M=null,D="unset"})}function pe(){return D==="unsupported"?"Folder picking needs Chrome/Edge on desktop — on phones backups download instead.":D==="unset"?"No folder chosen yet.":D==="prompt"?"Tap Choose folder to allow access again.":D==="denied"?"Access was denied — choose the folder again.":D==="granted"&&M?`Folder: ${M.name}`:"Checking…"}async function me(){if(!zt()){f("Folder access needs Chrome or Edge");return}try{const t=await window.showDirectoryPicker({id:"daily-report-backup",mode:"readwrite"});await ce("backupDir",t),M=t,D="granted",f("Backup folder set")}catch(t){t&&t.name==="AbortError"||f("Couldn't open that folder")}S()}async function ge(){try{await le("backupDir")}catch{f("Couldn't remove folder");return}M=null,D="unset",f("Backup folder removed"),S()}async function fe(){if(M){try{const t=await M.requestPermission({mode:"readwrite"});D=t==="granted"?"granted":"denied",f(t==="granted"?"Folder access granted":"Access denied")}catch{D="denied"}S()}}async function he(){const t=c.exportBackup(),e=it();if(D==="granted"&&M)try{const i=await(await M.getFileHandle(e,{create:!0})).createWritable();await i.write(t),await i.close(),f("Backup saved to your folder"),Ut();return}catch{}z(e,t,"application/json"),f("Backup downloaded")}async function be(){if(D!=="granted"||!M)return[];const t=[];try{for await(const e of M.values())if(e&&e.kind==="file"&&/\.json$/i.test(e.name))try{const a=await e.getFile();t.push({name:e.name,modified:a.lastModified})}catch{}}catch{return t}return t.sort((e,a)=>a.modified-e.modified),t}async function Ut(){const t=document.getElementById("folder-backup-list");if(!t)return;if(D!=="granted"||!M){t.innerHTML='<button class="ghost-btn compact" data-action="trigger-import">Import from a file instead</button>';return}t.innerHTML='<p class="item-meta">Loading backups…</p>';const e=await be();if(!document.getElementById("folder-backup-list"))return;e.length?t.innerHTML=e.map(i=>`
...
Days already in the app on those dates will be overwritten.`))return;z(it("daily-report-pre-import"),c.exportBackup(),"application/json");const o=c.importReport(a);if(!o){f("That file doesn't look like a valid Daily Report backup.");return}f(`Imported ${o.days} day(s)${o.habits?` + ${o.habits} new habit(s)`:""}`),S();return}if(i==="wrong-app"){f("That backup belongs to another app (e.g. Iron Log) — it can’t be imported into Daily Report.");return}f("That file doesn't look like a valid Daily Report backup.")}async function ve(){if(!_){f("Use the browser menu: Install / Add to Home Screen");return}try{_.prompt();const t=await _.userChoice;t&&t.outcome==="accepted"&&f("Installing Daily Report…")}catch{}_=null,S()}function ke(t){const e=/daily-report-v(\d+)/.exec(t||"");return e?Number(e[1]):null}async function $e(){q=!0,mt=!1,B="Checking for updates… (needs internet)",S();try{"serviceWorker"in navigator&&navigator.serviceWorker.getRegistration&&navigator.serviceWorker.getRegistration().then(e=>{e&&e.update&&e.update().catch(()=>{})}).catch(()=>{})}catch{}if(typeof fetch>"u"){q=!1,B="This browser can’t check — but the app itself works offline. Use Export backup to protect your data.",S();return}const t=setTimeout(()=>{q&&(q=!1,B="Couldn't reach the server — offline? The app itself works offline; updating needs internet.",S())},12e3);try{const e=await fetch("./sw.js",{cache:"no-store"});if(!e.ok)throw new Error(`http ${e.status}`);const a=await e.text();clearTimeout(t);const i=ke(a);q=!1,i===null?B="Reached the server but couldn’t read its version. Your data is safe on this device.":(It=i,i>dt?(mt=!0,B=`Update found: v${i} (you have v${dt}) — tap Save backup & restart.`):B=`You're on the latest version (v${dt}). The app works offline.`)}catch{clearTimeout(t),q=!1,B="Couldn't reach the server — offline, or this file wasn't opened from the installed/hosted app. The app itself works offline; updating needs internet."}S()}async function we(){z(it("daily-report-pre-update"),c.exportBackup(),"application/json"),f("Backup saved — updating app…"),B=`Backup saved — updating to v${It||"?"}…`;const t=()=>window.location.reload();try{if("serviceWorker"in navigator&&navigator.serviceWorker.getRegistration){const e=await navigator.serviceWorker.getRegistration().catch(()=>null);if(e&&e.unregister){e.unregister().then(t).catch(t),setTimeout(t,3e3);return}}}catch{}setTimeout(t,900)}function Se(){const t=c.getSettings(),e=c.getAllHabits(),a=c.getPinnedTasks(),i=c.lockedReports();return`
    ...
    <section class="manage-card">
      ...
      <p class="item-meta">Version: ${b(Kt)}</p>
                    ...
                    <article class="manage-card goal-card ${o?"goal-earned":""}">
                      <div class="section-head">
                        <div>
                          ...
                          <div class="item-meta">${Lt(s.tier)} · “${b(s.rewardTitle)}” · ${b(r)}</div>
  ...
  `}function j(t){if(/^\d{4}-\d{2}$/.test(String(t||"")))return String(t);if(/^\d{4}-\d{2}-\d{2}$/.test(String(t||"")))return String(t).slice(0,7);const e=new Date;return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}`}function Pt(t,e){const[a,i]=String(t).split("-").map(Number),s=new Date(a,(i||1)-1+e,1);return`${s.getFullYear()}-${String(s.getMonth()+1).padStart(2,"0")}`}function xe(t){const[e,a]=String(t).split("-").map(Number);return new Date(e,(a||1)-1,1).toLocaleDateString(void 0,{month:"long",year:"numeric"})}function De(t){const[e,a]=String(t).split("-").map(Number),s=(new Date(e,a-1,1).getDay()+6)%7,n=new Date(e,a,0).getDate(),o=[];for(let r=0;r<s;r++)o.push(null);for(let r=1;r<=n;r++)o.push(`${e}-${String(a).padStart(2,"0")}-${String(r).padStart(2,"0")}`);return o}function Mt(t,e,a){const i=new Set(a||[]),s=De(e);return`
  ...
  `}function Ae(t,e){const a=(t==null?void 0:t.mode)||"forever",i=(t==null?void 0:t.until)||"",s=((t==null?void 0:t.weekdays)||[]).map(Number),n=((t==null?void 0:t.monthDays)||[]).map(Number),o=Array.isArray(t==null?void 0:t.yearDays)?[...t.yearDays].sort():[],r=Array.isArray(t==null?void 0:t.customDates)?[...t.customDates].sort():[],u=Array.isArray(t==null?void 0:t.exceptDates)?[...t.exceptDates].sort():Array.isArray(t==null?void 0:t.exceptions)?[...t.exceptions].sort():[],d=e&&e._exceptCal||j(g),y=e&&e._customCal||j(g),x=e&&e._yearMonth||"01";return`
      ...
      <div class="row-2">
        <label>Month
          <select id="year-month-select">
            ${Array.from({length:12},(l,k)=>k+1).map(l=>`<option value="${String(l).padStart(2,"0")}" ${x===String(l).padStart(2,"0")?"selected":""}>${new Date(2e3,l-1,1).toLocaleDateString(void 0,{month:"long"})}</option>`).join("")}
          </select>
        </label>
        <label>Day
  ...
  `}function Te(){if(!v)return"";if(v==="choose")return`
          ...
          <div class="form" style="margin-top:14px">
            ...
            <div>
              ...
              <div class="chip-row goal-kind-row">
                ${Et.map(o=>`<button type="button" class="chip ${a===o.id?"on":""}" data-action="set-goal-kind" data-kind="${o.id}">${o.label}</button>`).join("")}
              </div>
      ...
      <div class="modal-backdrop open" data-action="close-modal">
        <form class="sheet" data-form="forward" data-kind="${t}" data-id="${e}">
          ...
          <div class="form" style="margin-top:14px">
            <label>
              Forward to day
              <input name="targetDate" type="date" required value="${ae(i||g)}" />
            </label>
